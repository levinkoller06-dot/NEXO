...
- Schritt 010 und 011 wurden NICHT im echten Browser/Canvas geprüft (nur per Node-Nachbildung der Formel) – der Nutzer testet direkt selbst in der laufenden App. Echte Bildrate mit 146.220 Punkten in diesem Prototyp noch nicht gemessen; falls zu langsam, hat der Nutzer einen Rückbau der Punktzahl ausdrücklich als Option genannt.
...
- Nächster möglicher Schritt: Nutzer-Test von Schritt 011 in der echten App abwarten (Bildrate mit 146.220 Punkten, Frontalansicht-Erkennbarkeit, ovale Mundöffnung). Nutzer hat explizit gesagt: falls es nicht funktioniert, wird die Punktzahl wieder zurückgebaut. Danach nach Auftrag direkt den Cloud-Core und die Modelladapter planen.
