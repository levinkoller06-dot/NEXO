...
- Sprach- und Textaufträge, begrenzter Gesprächsverlauf, Browser-TTS und Mundanimation beim Sprechen.
...
- PC-Freigabe pro Sitzung mit sichtbarem Hinweis, dass Screenshots an den aktiven Anbieter gehen. Globale Stopp-Taste Strg+Alt+F12, Stopp im HUD und im Bestätigungsdialog, Verbindungsüberwachung.
...
- Kein echter Desktop-/Mikrofon-/Hotkey-End-to-End-Test in Schritt 020; native Kompilierung, Logik und API-Protokoll wurden geprüft.
...
- 30 Regressionstests erfolgreich: Fehlerfälle R1–R7, Session-/CSRF-Prüfungen, Auftragssperre/Stopp, mehrere Werkzeugrunden, Bilddatenübertragung, Mauskoordinaten, abgelehnte Bestätigungen, Mikrofonzustände und Reihenfolge.
...
- Planung/NEXO-Obsidian-Plan/Schritte/020 2026-09-20 KI-Desktopsteuerung und Fehlerbehebung.md: vollständige Übergabe.
- Planung/NEXO-Obsidian-Plan/NEXO Planung und Ziel.md: langfristiges Ziel.

## Als Nächstes
NEXO starten.cmd öffnen, Fokus wählen, PC-Steuerung freigeben und einen einfachen Auftrag testen. Danach tatsächliche Klickgenauigkeit, Mikrofon, globalen Stopp und Darstellung prüfen. Weitere Umsetzung erfolgt nur nach Auftrag.
